...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m15(message) => "错误： ${message}";
  ...
  static String m20(message) => "请求数据时应用出现问题，请联系管理员解决问题： ${message}";
  ...
  static String m24(minute) => "${minute} 分钟前";
  ...
  static String m28(itemCount) => "${itemCount} 项";
  ...
  static String m33(percent) => "销售额 ${percent}%";
  ...
  static String m41(total) => "${total} 个商品";
  ...
  static String m46(length) => "我们找到了 ${length} 件商品";

  static String m47(week) => "第 ${week} 周";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "subTitleOrderConfirmed": MessageLookupByLibrary.simpleMessage(
            "感谢您在 FluxStore 的订单。我们正在快速处理您的订单。请稍后关注确认电子邮件"),
