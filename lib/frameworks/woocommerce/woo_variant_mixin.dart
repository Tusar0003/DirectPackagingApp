    ...
    if (checkProductAttribute) {
      for (var attr in product.attributes!) {
        ...
        if (attrClone.name?.isNotEmpty ?? false) {
          ...
          final attributeLayout = isDesktop || kIsWeb
              ? ProductDetailAttributeLayout.web
              : kProductDetail.attributeLayout;
          ...
          listWidget.addAll([
            ...
            if (attributeLayout != ProductDetailAttributeLayout.inline)
