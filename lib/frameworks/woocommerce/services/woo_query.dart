...
class ProductQuery {
  ...
  ProductQuery.parse({
    ...
    this.attribute = attribute is String ? attribute : null;
    this.attributeId = attributeId != null ? '$attributeId' : null;
  ...
  ProductQuery.fromJson(dynamic json) {
    ...
    attribute = json['attribute'] is String ? json['attribute'] : null;
    ...
    perPage = int.tryParse('${json['perPage']}');
  ...
  String toParams({bool hideOutOfStock = true}) {
    ...
    if (attributeId?.isNotEmpty ?? false) {
      params += '&attribute_term=$attributeId';
    }
