      ...
      case 'order':
        {
          ...
          onTap = user != null ? () => openMyOrder(context, user) : () {};
          break;
        }
      case 'point':
        {
      ...
      case 'privacy':
        {
          ...
          onTap = () =>
              onTapOpenPrivacy(context, generalSetting: subGeneralSetting);
          break;
        }
      case 'about':
        {
          ...
          onTap = () => openAboutUS(context, generalSetting: subGeneralSetting);
          break;
        }
